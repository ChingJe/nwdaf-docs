...
<tr class="even">
<td>Device Triggering Delivery Report Notification</td>
<td>{notification_uri}</td>
<td>POST</td>
<td>Report a device triggering delivery report to SCS/AS.</td>
</tr>
</tbody>
</table>
...
<p>This URI shall be provided within the "notificationDestination" attribute in the DeviceTriggering type.</p></td>
</tr>
</tbody>
</table>
...
To report the delivery status of the device triggering delivery, the SCEF shall use the HTTP POST method on the notification endpoint as follows:
...
| DeviceTriggeringDeliveryReportNotification | 1           | The Device Triggering delivery report. |
