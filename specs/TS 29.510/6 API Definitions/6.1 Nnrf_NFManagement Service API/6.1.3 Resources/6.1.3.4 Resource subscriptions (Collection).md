...
release: '18'
clause: 6.1.3.4
title: '6.1.3.4 Resource: subscriptions (Collection)'
...
<p>- Target NF type</p>
<p>- Target Service Name</p>
<p>- Callback URI of the Requester NF</p></td>
</tr>
</tbody>
</table>
...
<p>The "cause" attribute shall be set to "INVALID_CLIENT" if some or all attributes of the NF Service Consumer in the subscripton request do not match the requester information in, e.g. its public key certificate.</p></td>
</tr>
<tr class="even">
<td>ProblemDetails</td>
<td>O</td>
...
<p>- SUBSCRIPTION_NOT_ALLOWED</p></td>
</tr>
<tr class="odd">
