...
release: '18'
clause: 6.1.6.2.36
title: '6.1.6.2.36 Type: NasSecurityMode'
...
|--------------------|--------------------|-----|-------------|----------------------------------------------|
| integrityAlgorithm | IntegrityAlgorithm | M   | 1           | Indicates the integrity protection algorithm |
| cipheringAlgorithm | CipheringAlgorithm | M   | 1           | Indicates the ciphering algorithm            |
