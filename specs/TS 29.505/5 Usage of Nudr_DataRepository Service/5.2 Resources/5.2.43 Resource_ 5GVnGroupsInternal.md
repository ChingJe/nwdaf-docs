...
clause: 5.2.43
title: '5.2.43 Resource: 5GVnGroupsInternal'
...
This resource represents a read-only view of the collection resource of 5G VN Group data, so it can be queried based on the Internal Group Id from NF Service Consumers having such Id as the only way to identify a group (e.g. PCF).
...
|--------------------|----------------|-----|-------------|-------------------------------------------------------------------------------------------------------|
| internal-group-ids | array(GroupId) | M   | 1..N        | Return those 5G VN groups whose Internal Group ID corresponds with any of the Group IDs in this list. |
