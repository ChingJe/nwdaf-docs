...
clause: 5.2.23
title: '5.2.23 Resource: IdentityData'
...
|-------------|-----------|-----|-------------|------------------------------------------------------------------|
| app-port-id | AppPortId | O   | 0..1        | Application port identity, see 3GPP TS 23.501 \[4\] clause 4.4.7 |
...
<td>1</td>
<td>200 OK</td>
<td>Upon success, a response body containing the identity data that corresponds to the provided ueId</td>
</tr>
<tr class="even">
