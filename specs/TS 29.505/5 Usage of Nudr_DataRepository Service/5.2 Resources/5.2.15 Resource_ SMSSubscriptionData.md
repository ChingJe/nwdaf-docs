...
clause: 5.2.15
title: '5.2.15 Resource: SMSSubscriptionData'
...
This resource represents the subscribed SMS Subscription Data for a SUPI for use in a serving PLMN. It is queried by the AMF via the UDM after registering.
...
Resource URI: {apiRoot}/nudr-dr/\<apiVersion\>/subscription-data/{ueId}/{serving-plmn-id}/provisioned-data/sms-data
