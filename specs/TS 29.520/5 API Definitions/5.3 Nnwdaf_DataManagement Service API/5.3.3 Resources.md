...
<img src="../../assets/rendered/image49.png" style="width:5.31667in;height:2.19861in" />
...
| NWDAF Data Management Subscriptions           | /subscriptions                  | POST                            | Creates a new Individual NWDAF Data Management Subscription resource.                                          |
| Individual NWDAF Data Management Subscription | /subscriptions/{subscriptionId} | DELETE                          | Deletes an Individual NWDAF Data Management Subscription identified by subresource {subscriptionId}.           |
|                                               |                                 | PUT                             | Modifies an existing Individual NWDAF Data Management Subscription identified by subresource {subscriptionId}. |
...
| apiRoot | string    | See clause 5.3.1 |
...
| NnwdafDataManagementSubsc | M   | 1           | Create a new Individual NWDAF Data Management Subscription resource. |
...
<tr class="even">
<td>NnwdafDataManagementSubsc</td>
<td>M</td>
<td>1</td>
<td>201 Created</td>
<td>The creation of an Individual NWDAF Data Management Subscription resource is confirmed and a representation of that resource is returned.</td>
</tr>
<tr class="odd">
...
<p>NOTE 2: Failure cases are described in clause 5.3.7.</p></td>
</tr>
</tbody>
</table>
...
|----------|-----------|-----|-------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| Name     | Data type | P   | Cardinality | Description                                                                                                                                               |
| Location | string    | M   | 1           | Contains the URI of the newly created resource, according to the structure: {apiRoot}/nnwdaf-datamanagement/\<apiVersion\>/subscriptions/{subscriptionId} |
...
| Name           | Data type | Definition                                                     |
| apiRoot        | string    | See clause 5.3.1                                               |
| subscriptionId | string    | Identifies a subscription to the Nnwdaf_DataManagement Service |
...
|---------------------------|-----|-------------|--------------------------------------------------------------------------------------|
| Data type                 | P   | Cardinality | Description                                                                          |
| NnwdafDataManagementSubsc | M   | 1           | Parameters to replace a subscription to NWDAF Data Management Subscription resource. |
...
<td>1</td>
<td>200 OK</td>
<td>The Individual NWDAF Data Management Subscription resource was modified successfully and a representation of that resource is returned.</td>
</tr>
<tr class="odd">
<td>n/a</td>
<td></td>
...
<td>The Individual NWDAF Data Management Subscription resource was modified successfully.</td>
</tr>
<tr class="even">
...
<td><p>Temporary redirection, during Individual NWDAF Data Management Subscription modification.</p>
<p>(NOTE 3)</p></td>
</tr>
<tr class="odd">
<td>RedirectResponse</td>
...
<td><p>Permanent redirection, during Individual NWDAF Data Management Subscription modification.</p>
<p>(NOTE 3)</p></td>
</tr>
<tr class="even">
<td>ProblemDetails</td>
...
<p>NOTE 2: Failure cases are described in clause 5.3.7.</p>
...
<td></td>
<td>204 No Content</td>
<td>Successful case: The Individual NWDAF Data Management Subscription resource matching the subscriptionId was deleted.</td>
</tr>
<tr class="odd">
...
<td>0..1</td>
<td>200 OK</td>
<td>Successful case: The Individual NWDAF Data Management Subscription resource matching the subscriptionId was deleted and including the stored unsent events in the response.</td>
</tr>
<tr class="even">
<td>RedirectResponse</td>
<td>O</td>
<td>0..1</td>
<td>307 Temporary Redirect</td>
<td><p>Temporary redirection, during Individual NWDAF Data Management Subscription deletion.</p>
<p>(NOTE 2)</p></td>
</tr>
<tr class="odd">
<td>RedirectResponse</td>
...
<td>0..1</td>
<td>308 Permanent Redirect</td>
<td><p>Permanent redirection, during Individual NWDAF Data Management Subscription deletion.</p>
<p>(NOTE 2)</p></td>
</tr>
<tr class="even">
