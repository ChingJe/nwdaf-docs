...
release: '18'
clause: 5.1.6.2.6
title: 5.1.6.2.6 Type SliceLoadLevelInformation
...
| loadLevelInformation | LoadLevelInformation | M   | 1           | Load level information which applies for each network slice identified by snssais. |               |
| snssais              | array(Snssai)        | M   | 1..N        | Identification(s) of network slice to which the subscription applies.              |               |
