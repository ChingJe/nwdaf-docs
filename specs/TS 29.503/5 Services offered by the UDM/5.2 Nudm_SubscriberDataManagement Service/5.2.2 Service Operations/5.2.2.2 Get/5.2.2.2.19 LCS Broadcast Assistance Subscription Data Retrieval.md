...
release: '18'
clause: 5.2.2.2.19
title: 5.2.2.2.19 LCS Broadcast Assistance Subscription Data Retrieval
...
Figure 5.2.2.2.19-1 shows a scenario where the NF service consumer (e.g. AMF) sends a request to the UDM to receive the UE's LCS Broadcast Assistance Subscription data (see TS 23.273 \[38\]). The request contains the UE's identity (/{supi}), the type of the requested information (/lcs-bca-data) and query parameters (supported-features, plmn-id).
