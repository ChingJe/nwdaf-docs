...
release: '18'
clause: 5.2.2.2.18
title: 5.2.2.2.18 V2X Subscription Data Retrieval
...
Figure 5.2.2.2.18-1 shows a scenario where the NF service consumer (e.g. AMF) sends a request to the UDM to retrieve a UE's subscribed V2X data (see also TS 23.287 \[51\] clause 6.5.2). The request contains the identifier of the UE (/{supi}), the type of the requested information (/v2x-data) and query parameters (supported-features).
