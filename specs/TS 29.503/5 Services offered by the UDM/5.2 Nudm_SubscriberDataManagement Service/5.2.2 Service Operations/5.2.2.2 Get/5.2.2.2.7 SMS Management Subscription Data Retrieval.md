...
release: '18'
clause: 5.2.2.2.7
title: 5.2.2.2.7 SMS Management Subscription Data Retrieval
...
Figure 5.2.2.2.7-1 shows a scenario where the NF service consumer (e.g. SMSF) sends a request to the UDM to receive the UE's SMS Management Subscription Data (see also TS 23.502 \[3\], clause 4.13.3.1). The request contains the UE's identity (/{supi}) and the type of the requested information (/sms-mng-data).
