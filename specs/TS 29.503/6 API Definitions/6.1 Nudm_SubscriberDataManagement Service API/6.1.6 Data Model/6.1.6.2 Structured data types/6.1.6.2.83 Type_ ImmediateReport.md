...
release: '18'
clause: 6.1.6.2.83
title: '6.1.6.2.83 Type: ImmediateReport'
...
|----------------------|-------------|--------------------------------------------------------------------------|---------------|
| SubscriptionDataSets | 1           | UE based subscription data sets that to be monitored in SdmSubscription. |               |
| array(SharedData)    | 1..N        | Shared subscription data sets that to be monitored in SdmSubscription.   |               |
