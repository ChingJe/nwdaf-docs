...
release: '18'
clause: 6.1.6.2.12
title: '6.1.6.2.12 Type: SscModes'
...
|-----------------|----------------|-----|-------------|---------------------------------------------------|
| defaultSscMode  | SscMode        | M   | 1           | Default SSC mode                                  |
| allowedSscModes | array(SscMode) | O   | 1..2        | Additional SSC modes allowed for the data network |
