...
release: '18'
clause: 6.1.6.2.85
title: '6.1.6.2.85 Type: UcSubscriptionData'
...
|---------------------------|------------------|-----|-------------|----------------------------------------------------------------------------------------------------|
| userConsentPerPurposeList | map(UserConsent) | O   | 1..N        | A map user consent (list of key-value pairs where UcPurpose serves as key; see clause 6.1.6.3.20). |
