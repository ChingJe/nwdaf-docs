...
release: '18'
clause: 6.1.6.2.11
title: '6.1.6.2.11 Type: PduSessionTypes'
...
|---------------------|-----------------------|-----|-------------|-----------------------------------------------------------------------------|
| defaultSessionType  | PduSessionType        | C   | 0..1        | Default session type, shall be present unless the VnGroupData is supported. |
| allowedSessionTypes | array(PduSessionType) | O   | 1..N        | Additional session types allowed for the data network                       |
