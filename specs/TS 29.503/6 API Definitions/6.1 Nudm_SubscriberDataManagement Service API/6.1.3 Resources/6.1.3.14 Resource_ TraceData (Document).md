...
release: '18'
clause: 6.1.3.14
title: '6.1.3.14 Resource: TraceData (Document)'
...
If "plmn-id" is included, UDM shall return the Trace Data for the SUPI associated to the PLMN or SNPN identified by "plmn-id".
...
<tr class="even">
<td>TraceDataResponse</td>
<td>M</td>
<td>1</td>
<td>200 OK</td>
<td>Upon success, a response body containing the Trace Data shall be returned.</td>
</tr>
<tr class="odd">
