...
release: '18'
clause: 6.1.3.23
title: '6.1.3.23 Resource: LcsPrivacySubscriptionData (Document)'
...
<tr class="odd">
<td colspan="3">NOTE: SUPI is only used to retrieve Location Privacy profile by GMLC.</td>
</tr>
</tbody>
</table>
...
<td>1</td>
<td>200 OK</td>
<td>Upon success, a response body containing the LCS Privacy Subscription Data shall be returned (see TS 23.273 [38] clause 5.4.2)</td>
</tr>
<tr class="odd">
