...
release: '18'
clause: 6.1.3.22
title: '6.1.3.22 Resource: CagAck (Document)'
...
| AcknowledgeInfo | M   | 1           | Contains the provisioning time stamp as received within the CagInfo. |
...
<td>Successful receiving the UE acknowledgement for CAG configuration update.</td>
</tr>
<tr class="odd">
