...
release: '18'
clause: 6.1.3.6
title: '6.1.3.6 Resource: SmfSelectionSubscriptionData (Document)'
...
If "plmn-id" is included, UDM shall return the SMF Selection Subscription Data for the SUPI associated to the PLMN or SNPN identified by "plmn-id".
...
<tr class="even">
<td>SmfSelectionSubscriptionData</td>
<td>M</td>
<td>1</td>
<td>200 OK</td>
<td>Upon success, a response body containing the SMF Selection Subscription Data shall be returned.</td>
</tr>
<tr class="odd">
