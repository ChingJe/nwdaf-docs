...
Table 6.5.6.2.18-1: Definition of type UmtTime

| Attribute name | Data type | P   | Cardinality | Description         |
|----------------|-----------|-----|-------------|---------------------|
| timeOfDay      | TimeOfDay | M   | 1           | see TS 29.571 \[7\] |
| dayOfWeek      | DayOfWeek | M   | 1           | see TS 29.571 \[7\] |
